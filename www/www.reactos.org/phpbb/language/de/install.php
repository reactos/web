...
*
* @package language
* @version $Id: install.php 617 2013-09-29 10:21:18Z pyramide $
...
$lang = array_merge($lang, array(
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Dein MySQL-Datenbankschema ist veraltet. phpBB hat ein Schema für MySQL 3.x/4.x erkannt, der Server läuft aber mit MySQL %2$s.<br /><strong>Du musst das Schema aktualisieren, um mit dem Update fortfahren zu können.</strong><br /><br />Bitte verfahre dabei wie im <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge-Base-Artikel zur Aktualisierung des MySQL-Schemas</a> beschrieben wird (<a href="https://www.phpbb.de/go/3/no_default">deutschsprachige Fassung</a>). Wenn Du dabei auf Probleme stößt, nutze bitte <a href="https://www.phpbb.com/community/viewforum.php?f=46">unsere Support-Foren</a> (<a href="https://www.phpbb.de/go/3/supportforum">deutschsprachige Foren</a>).',
