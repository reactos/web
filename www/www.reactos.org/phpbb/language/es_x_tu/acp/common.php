...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> se debe establecer en <samp>pass</samp>. Puedes comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP conversión de caracteres de salida no está configurado correctamente',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> se debe establecer en <samp>pass</samp>. Puedes comprobar el valor actual en la página de <samp>Información de PHP</samp>.',
...
$lang = array_merge($lang, array(
	...
	'LOG_DELETE_POST'		=> '<strong>Mensaje borrado “%1$s” escrito por</strong><br />» %2$s',
