...
$lang = array_merge($lang, array(
	...
	'PHP_VERSION_OLD'	=> 'La versione di PHP in uso su questo server non sarà più supportata dalle versioni future di phpBB. %sDettagli%s',	
...
$lang = array_merge($lang, array(
	...
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Non approvato l’argomento “%1$s” per questo motivo</strong><br />%2$s',
    ...
    'LOG_WARNINGS_DELETED'      => '<strong>Cancellati %2$s richiami utente</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
