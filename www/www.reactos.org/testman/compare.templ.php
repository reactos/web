...
<table id="comparetable" class="datatable" cellspacing="0" cellpadding="0"><thead><tr class="head"><th class="TestSuite"><?php echo $testman_langres["testsuite"];?></th><?php echo $table_summary; ?></tr></thead><tbody><tr class="even"><td id="totals"><?php echo $testman_langres["totals"]; ?></td><?php echo $table_totals; ?></tr><?php echo $table_performance; ?><tr class="<?php echo $summary_class; ?>"><td id="summary"><?php echo $testman_langres["summary"]; ?></td><?php echo  $final_summary; ?></tr><tr class="separator"></tr><?php echo $table_results; ?></tbody></table>
