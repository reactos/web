...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php print $scripts; ?>
<?php
  //language files for socialSharePrivacy
  switch($language->language){
	case "de":
		echo '<script type="text/javascript" src="'.$directory.'/js/jquery.ssp.de.js"></script>';
	break;
	case "fr":
		echo '<script type="text/javascript" src="'.$directory.'/js/jquery.ssp.fr.js"></script>';
	break;
	case "ru":
		echo '<script type="text/javascript" src="'.$directory.'/js/jquery.ssp.ru.js" charset="UTF-8"></script>';
	break;
	case "es":
		echo '<script type="text/javascript" src="'.$directory.'/js/jquery.ssp.es.js"></script>';
	break;
	default:
	break;
  }
