...
$lang = array_merge($lang, array(
	...
	'BBCODE_TAG_DEF_TOO_LONG'	=> 'La definición de etiqueta que introduciste es muy larga, por favor acórtala.',
	...
	'HTML_REPLACEMENT_EXPLAIN'	=> 'Aquí define el reemplazo HTML por defecto (cada plantilla puede tener su propio reemplazo HTML). ¡No olvides poner las marca claves que usastes arriba!!',

	'TOKEN'				=> 'marca clave',
	'TOKENS'			=> 'marca claves',
	'TOKENS_EXPLAIN'	=> 'Las marca claves son contenedores de la información suministrada por el usuario. La entrada será válida solo si coincide con la definición correspondiente. Si es necesario puedes numerarlas, añadiendo un número como último caracter entre llaves, ej. {USERNAME1}, {USERNAME2}.<br /><br />Sumado a estas marca claves puedes usar cualquier palabra presente en su directorio language/ como estas: {L_<em>&lt;stringname&gt;</em>} donde <em>&lt;stringname&gt;</em> es la palabra traducida que quiere agregar. Por ejemplo, {L_WROTE} se mostrará como “escrito” o su traducción de acuerdo al idioma usado por el usuario.<br /><br /><strong>Por favor ten en cuenta que solo las marca claves listadas debajo son las que se pueden usar en los BBCodes personalizados.</strong>',
	...
	'tokens'	=> array(
		...
		'RELATIVE_URL'	=> 'Una URL relativa. Puedes utilizar esto para que coincida con las partes de una URL, pero ten cuidado: una URL completa es una URL relativa válida. Cuando se desea utilizar URLs relativas de tu foro, utiliza la ficha LOCAL_URL',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Aquí puedes controlar qué nombres de usuario no se permitirá que sean utilizados. Nombres de usuario deshabilitados pueden contener un comodín (*).',
	...
	'DISALLOWED_ALREADY'		=> 'El nombre que ingresaste no puede ser deshabilitado.',
