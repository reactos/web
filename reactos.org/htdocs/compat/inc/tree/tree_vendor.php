...
&gt; <a href="<?php echo $RSDB_intern_link_name_letter; ?>all">Browse Database</a> &gt; By Vendor<a href="<?php echo $RSDB_intern_index_php; ?>?page=about"><img src="media/pictures/compatibility_small.jpg" vspace="1" border="0" align="right"></a>
</h1> 
  ...
  elseif (isset($_GET['group'])) {
	...
	if (isset($_GET['item']) && $_GET['item'] != '') {
		...
		if (isset($_GET['vendor']) && $_GET['vendor'] != '') {
			...
			include("inc/tree/tree_vendor_flat.php");
		}
	}
