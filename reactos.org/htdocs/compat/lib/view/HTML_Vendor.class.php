...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
  ...
  <tr> 
    <td valign="top" bgcolor="<?php
								 ...
								 ?>"> <div align="left"><font face="Arial, Helvetica, sans-serif">&nbsp;<b><a href="<?php echo $RSDB_intern_link_db_sec.'vendor&amp;vendor='.$result_page['vendor_id']; ?>"><?php echo $result_page['vendor_name']; ?></a></b></font> 
        </div></td>
